import { ALL_NODE_FILTER, CORE_NODES_CATEGORY, CUSTOM_NODES_CATEGORY, PERSONALIZED_CATEGORY, REGULAR_NODE_FILTER, SUBCATEGORY_DESCRIPTIONS, TRIGGER_NODE_FILTER, UNCATEGORIZED_CATEGORY, UNCATEGORIZED_SUBCATEGORY } from '@/constants';
import { ICategoriesWithNodes, INodeCreateElement, INodeItemProps } from '@/Interface';
